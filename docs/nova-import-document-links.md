...
The bounded Nova local-file import phase exposes negotiated LSP `textDocument/documentLink` navigation for editor-owned Nova buffers, including scoped `@/path.nova` workspace-root imports.
