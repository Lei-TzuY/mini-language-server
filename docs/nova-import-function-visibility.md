...
- wildcard name-merging import syntax beyond existing bare imports, nested/package namespace objects, namespace-object identity beyond the bounded explicit local-file star/selective export graph, or cross-module namespace rename;
