...
- wildcard name-merging import syntax beyond existing bare imports, nested/package namespace objects, namespace-object identity or rename beyond the bounded explicit local-file star/selective export graph;
