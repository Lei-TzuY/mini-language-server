...
- exact Nova hover type information for explicitly typed parameters, explicitly typed locals, literal-initialized locals, exact-reference local aliases, and bounded same-file direct function-call initializers when type knowledge is available
