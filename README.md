...
- executable Nova adapter semantics for functions, typed parameters, locals, scoped references, and deterministic unresolved/duplicate diagnostics; the final product lexically masks line comments, block comments, and quoted strings before structural scans while preserving exact source offsets
