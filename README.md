...
- hover, lexical-scope-aware completion, semantic tokens (full, range, and negotiated full/delta), document symbols, workspace symbol search, negotiated signature help, negotiated Nova parameter inlay hints, exact-snapshot Nova function folding ranges, negotiated exact-workspace Nova call hierarchy, and negotiated exact-workspace Nova reference-count CodeLens
