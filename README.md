...
- bounded Nova return validation reports deterministic `nova.return-type` diagnostics when Int, String, or Bool literal returns conflict with an explicit function return annotation
