...
- conservative Nova function-result inference for uniquely resolved unannotated functions whose value-bearing returns are all Int, String, or Bool literals of one consistent type; conflicting or non-literal returns remain unknown, and explicit return annotations are never overridden
