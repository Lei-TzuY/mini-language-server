...
- conservative Nova function-result inference for uniquely resolved unannotated functions whose value-bearing returns consistently resolve to one bounded Int, String, or Bool type through literals or uniquely resolved direct calls to explicitly annotated functions; conflicting, ambiguous, unsupported, recursively inferred, or otherwise unknown returns remain unknown, and explicit return annotations are never overridden
