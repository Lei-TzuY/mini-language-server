...
- bounded Nova return validation reports deterministic `nova.return-type` diagnostics when Int, String, or Bool literals or exact semantic references with bounded parameter/local type knowledge conflict with an explicit function return annotation
