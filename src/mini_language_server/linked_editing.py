"""Exact-snapshot LSP linked-editing-range capability."""
...
from .document_highlights import NovaProductLanguageServer as _NovaProductLanguageServer
from .server import ServerState


class NovaProductLanguageServer(_NovaProductLanguageServer):
    """Product server extended with generic exact-snapshot linked editing ranges."""
    ...
    def handle(self, message: dict[str, Any]) -> dict[str, Any] | None:
        ...
        if (
            ...
            return self._handle_linked_editing_range(
        ...
        if (
            ...
            and self._client_supports_linked_editing(message.get("params"))
        ):
    ...
    @staticmethod
    def _client_supports_linked_editing(params: Any) -> bool:
    ...
    def _handle_linked_editing_range(self, request_id: Any, params: Any) -> dict[str, Any]:
        ...
        try:
            ...
            result = {"ranges": [self._range(source, span) for span in spans]}
            self.requests.checkpoint(context)
