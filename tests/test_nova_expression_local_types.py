...
def test_expression_initializer_exposes_local_type_in_inlay_hints() -> None:
...
def test_mixed_expression_initializer_remains_conservative() -> None:
    server = initialized_server()
    uri = "file:///workspace/main.nova"
...
def test_cross_file_expression_local_type_rebinds_after_change() -> None:
    server = initialized_server()
